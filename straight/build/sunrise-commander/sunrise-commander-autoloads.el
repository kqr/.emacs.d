...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-commander" '("sunrise-commander-unload-function" "sr-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-buttons" '("sr-buttons-")))

;;;***

;;;### (autoloads nil "sunrise-x-checkpoints" "sunrise-x-checkpoints.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from sunrise-x-checkpoints.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-checkpoints" '("sr-" "sunrise-x-checkpoints-unload-function")))

;;;***

;;;### (autoloads nil "sunrise-x-loop" "sunrise-x-loop.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from sunrise-x-loop.el
 (eval-after-load 'sunrise-commander '(sr-extend-with 'sunrise-x-loop))

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-loop" '("sr-loop-" "sunrise-x-loop-unload-function")))

;;;***

;;;### (autoloads nil "sunrise-x-mirror" "sunrise-x-mirror.el" (0
;;;;;;  0 0 0))
;;; Generated autoloads from sunrise-x-mirror.el
 (eval-after-load 'sunrise-commander '(sr-extend-with 'sunrise-x-mirror))

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-mirror" '("sr-mirror-" "sunrise-x-mirror-unload-function")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-modeline" '("sr-modeline")))

;;;***

;;;### (autoloads nil "sunrise-x-old-checkpoints" "sunrise-x-old-checkpoints.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from sunrise-x-old-checkpoints.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-old-checkpoints" '("sr-checkpoint-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-popviewer" '("sr-popviewer-" "sunrise-x-popviewer-unload-function")))

;;;***

;;;### (autoloads nil "sunrise-x-tabs" "sunrise-x-tabs.el" (0 0 0
;;;;;;  0))
;;; Generated autoloads from sunrise-x-tabs.el
 (eval-after-load 'sunrise-commander '(sr-extend-with 'sunrise-x-tabs))

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-tabs" '("sr-" "sunrise-x-tabs-unload-function")))

;;;***

;;;### (autoloads nil "sunrise-x-tree" "sunrise-x-tree.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-tree" '("sunrise-x-tree-unload-function" "sr-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sunrise-x-w32-addons" '("sr-w32-" "sunrise-x-w32-addons-unload-function")))
