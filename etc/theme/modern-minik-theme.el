  ...
  (setq
   ...
   (append
    ...
    '(
      ...
      (ediff-current-diff-A                  ((t :background "#27518c")))
      (ediff-current-diff-B                  ((t :background "#604d31")))
      (ediff-current-diff-C                  ((t :background "#5a2387")))
      (ediff-fine-diff-A                     ((t :background "#3475a4")))
      (ediff-fine-diff-B                     ((t :background "#877021")))
