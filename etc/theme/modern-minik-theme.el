  ...
  (setq
   ...
   (append
    ...
    '(
      ...
      (ediff-current-diff-A                  ((t :background "#159263")))
      (ediff-current-diff-B                  ((t :background "#7a7a1a")))
      (ediff-current-diff-C                  ((t :background "#b8e186")))
      (ediff-fine-diff-A                     ((t :background "#2c7bb6")))
      (ediff-fine-diff-B                     ((t :background "#fdae61")))
      (ediff-fine-diff-C                     ((t :background "#4dac26")))
